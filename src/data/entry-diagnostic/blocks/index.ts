...
const seeds: BlockSeed[] = [
  {
    ...
    tasks: [
      makeReadingTask(
        B01,
        "D1",
        "У Маши 12 яблок, у Пети 8.",
        "Что нужно узнать?",
        [
          { id: "together", label: "Сколько яблок у детей вместе?" },
          { id: "masha", label: "Сколько яблок у Маши?" },
          { id: "peti", label: "Сколько яблок у Пети?" },
          { id: "extra", label: "Сколько яблок лишних?" },
        ],
        "together",
      ...
      makeReadingTask(
        B01,
        "D2",
        "В корзине 24 конфеты: 10 шоколадных, остальные — карамельки.",
        "Что нужно узнать?",
        [
      ...
      makeReadingTask(
        B01,
        "D3",
        "На полке 5 красных, 7 синих и 3 зелёных книг.",
        "Что нужно узнать?",
        [
