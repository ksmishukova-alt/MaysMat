...
export const PATTERN5_COMPLETENESS_AUDIT: Pattern5CompletenessRecord[] = [
  ...
  },
  {
    ...
    needsMethodChoice: false,
    needsPaperMode: false,
    suggestedE2E: "5.03 — классическая замена: 17 Ранкоров, 12 Бант",
    expectedAnswer: "17 Ранкоров и 12 Бант",
    notes:
      "Эталон паттерна 5 для profile 2: есть totalParticipants и totalFeature, чистая замена 8 vs 18. Первый кандидат в pilot wave.",
  },
  {
    methodTaskId: "5.4",
