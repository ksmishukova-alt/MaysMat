  ...
  return [
    ...
    ),
    {
      ...
      template: [
        ...
        "Вариант «0 девочек» не подходит — в задаче участвуют и мальчики, и девочки.",
      ],
    },
    {
      id: `${taskId}-diag-no-zero`,
      type: "single_select",
      title: "Может ли быть 0 девочек?",
      selectPrompt: "Подходит ли вариант, где девочек нет?",
      context: "В условии речь о мальчиках и девочках — оба вида должны участвовать.",
      options: [
        { id: "no", label: "Нет — девочек должно быть больше 0", emoji: "👧", correct: true },
        { id: "yes", label: "Да — можно без девочек", emoji: "0️⃣", correct: false },
      ],
      successMessage: "Верно! Ищем варианты, где и мальчиков, и девочек больше нуля.",
    },
    ws(
      taskId,
      "v1",
