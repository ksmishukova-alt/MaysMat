...
export const HEADS_LEGS_SOLUTION_LINES: Record<string, SolutionLine[]> = {
  ...
  "1.13": [
    ...
    {
      "template": "Пусть AT-AT будет [3], тогда AT-ST [9].",
      "blanks": [
        {
          "id": "1.13-b-1-0",
          "type": "number",
    ...
    {
      "template": "Проверка: [3×4 + 9×3 = 39] ног.",
      "blanks": [
        {
          "id": "1.13-b-2-0",
          "type": "expression",
    ...
    {
      "template": "В каждом роботе [1] штурмовик, значит штурмовиков [12].",
      "blanks": [
        {
          "id": "1.13-b-3-0",
          "type": "number",
  ...
  "7.7": [
    ...
    {
      "template": "Обновленный чек-лист для разработчика шага «Запиши решение словами»",
      "blanks": []
    },
    {
      "template": "Не использовать один общий шаблон для всех задач. Для каждой задачи хранить индивидуальный массив строк решения.",
      "blanks": []
    },
    {
      "template": "Каждый блок в квадратных скобках [ ] хранить как отдельное интерактивное поле: number, object, operation, expression, conclusion.",
      "blanks": [
        {
          "id": "7.7-b-12-0",
          "type": "object",
    ...
    {
      "template": "Для режима A показывать карточки строк и карточки вставок; проверять порядок строк и корректность вставок.",
      "blanks": []
    },
    {
      "template": "Для режима B показывать строки в правильном порядке, но скрывать значения внутри [ ].",
      "blanks": [
        {
          "id": "7.7-b-14-0",
          "type": "object",
    ...
    {
      "template": "Для режима C показывать только инструкцию «Запиши решение словами»; проверять ключевые элементы решения, а не дословное совпадение.",
      "blanks": []
    },
    {
      "template": "Для режима D принимать диагностический вывод только с объяснением причины. Если оба типа объектов названы как участвующие, варианты с 0 запрещены.",
      "blanks": []
    },
    {
      "template": "Для режима E поддержать таблицу или карточки натурального перебора: значение первого вида, остаток, проверка делимости, вывод.",
      "blanks": []
    },
    {
      "template": "Если задача неполная, ребёнок не должен сам добавлять недостающее число. Добавлять данные может только методист/редактор в тексте задачи.",
      "blanks": []
    },
    {
      "template": "В конце каждого решения ребёнок обязательно записывает строку «Ответ: ...» или «Вывод: ...».",
      "blanks": []
    },
    {
      "template": "Проверка текстового решения должна быть смысловой: допускаются разные формулировки при сохранении математических шагов.",
      "blanks": []
    },
    {
      "template": "Для задач с положительными ограничениями хранить параметры min_count: 1 и both_types_present: true.",
      "blanks": []
    }
  ]
