...
|---:|---|---|---|---|---|---|---|
| 1 | 1.1 | `heads-legs-1-01` | yes | single_path_assume | explicit_training_path | medium | approved: explicit_training_path (Wave P1) |
| 3 | 1.3 | `heads-legs-1-03` | yes | single_path_assume | explicit_training_path | medium | approved: explicit_training_path (Wave P1) |
| 11 | 2.1 | `heads-legs-2-01` | yes | single_path_assume | explicit_training_path | medium | approved: explicit_training_path (Wave P1) |
| 12 | 2.2 | `heads-legs-2-02` | yes | single_path_assume | explicit_training_path | medium | approved: explicit_training_path (Wave P1) |
| 13 | 2.3 | `heads-legs-2-03` | yes | single_path_assume | explicit_training_path | medium | approved: explicit_training_path (Wave P1) |
| 22 | 3.3 | `heads-legs-3-03` | yes | single_path_assume | explicit_training_path | medium | approved: explicit_training_path (Wave P1) |
| 23 | 3.4 | `heads-legs-3-04` | yes | single_path_assume | explicit_training_path | medium | approved: explicit_training_path (Wave P1) |

## Полная таблица (childRoute 1.x–3.x)

| UI | ID | title | 2-й путь | runner | рекомендация | риск | решение |
|---:|---|---|---|---|---|---|---|
| 1 | 1.1 | Звери и птицы | yes | single_path_assume | explicit_training_path | medium | approved: explicit_training_path (Wave P1) |
...
| 3 | 1.3 | Гусята и крокодильчики | yes | single_path_assume | explicit_training_path | medium | approved: explicit_training_path (Wave P1) |
...
| 11 | 2.1 | Клумбы около Лицея и Гимназии | yes | single_path_assume | explicit_training_path | medium | approved: explicit_training_path (Wave P1) |
| 12 | 2.2 | Коробки с карандашами | yes | single_path_assume | explicit_training_path | medium | approved: explicit_training_path (Wave P1) |
| 13 | 2.3 | Дроны-рабочие и дроны-пастухи | yes | single_path_assume | explicit_training_path | medium | approved: explicit_training_path (Wave P1) |
...
| 22 | 3.3 | Конфеты в классе | yes | single_path_assume | explicit_training_path | medium | approved: explicit_training_path (Wave P1) |
| 23 | 3.4 | Снежинки | yes | single_path_assume | explicit_training_path | medium | approved: explicit_training_path (Wave P1) |
